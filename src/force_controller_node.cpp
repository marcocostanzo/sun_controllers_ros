#include "sun_controllers_ros/ROSForceController.h"
#include "signal.h"
#include <memory>
...
std::unique_ptr<ROSForceController> force_controller;
...
int main(int argc, char *argv[])
{
    ...
    force_controller = patch::make_unique<ROSForceController>(
        nh_public,
        nh_private
    );
