...
void sun::ROSWrenchController::get_ros_params_topics_services_name(ros::NodeHandle &nh_private)
{
  ...
  nh_private.param("command_frame_id", command_frame_id_, std::string(""));
}
...
void sun::ROSWrenchController::print_params()
{
  ...
  output += "\tcommand_frame_id: " + command_frame_id_ + "\n";
...
*/
bool sun::ROSWrenchController::srv_server_set_enabled_cb_(std_srvs::SetBool::Request &request,
